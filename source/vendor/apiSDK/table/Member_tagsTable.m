...
不要手动修改
*/
#import "Member_tagsTable.h"

@implementation Member_tagsTable 
...
{          
    ...
    self.member_id = [self stringFormat:JSON[@"member_id"]];
...
- (NSString *) toJSON
{
    ...
    if(self.member_id!=nil){
        [res addObject:[self JSONItemFormat:@"\"member_id\":\"%@\"" data:self.member_id]];
    }
    if(self.name!=nil){
