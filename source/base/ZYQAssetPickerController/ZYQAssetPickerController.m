...
//    checkedIcon     = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:[NSString stringWithFormat:@"ZYQAssetPicker.Bundle/Images/%@@2x.png",(!IS_IOS7) ? @"AssetsPickerChecked~iOS6" : @"AssetsPickerChecked"]]];
    checkedIcon=[UIImage imageNamed:@"AssetsPickerChecked@2x"];
...
- (void)setupButtons
{
    ...
    //[button setBackgroundImage:[UIImage imageNamed:@"lkms_wc.png"] forState:UIControlStateNormal];
    //[button addTarget:self action:@selector(finishPickingAssets:) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *item=[[UIBarButtonItem alloc]initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:self action:@selector(finishPickingAssets:)];
...
//        button.frame = CGRectMake(0, 0, 31, 21);
//        [button setImage:[UIImage imageNamed:@"xqwback.png"] forState:UIControlStateNormal];
