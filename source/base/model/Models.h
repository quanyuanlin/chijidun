...
@property (nonatomic, retain) NSString *		pays;//支付方式
@property (nonatomic, retain) NSString *		pays_id;
...
@property (nonatomic, retain) NSString *		htotal;
@property (nonatomic, retain) NSString *		order_status;
@property (nonatomic, retain) NSString *		order_sstatus;
@property(nonatomic,strong)NSString *      left_time;//倒计时时间

@property (nonatomic, retain) NSString *		express_tele;//配送电话
@property (nonatomic, retain) NSString *		express_type;//配送方式
@property (nonatomic, retain) NSString *		times;//就餐时间
@property (nonatomic, retain) NSString *		days;//就餐时间
@property (nonatomic, retain) NSString *		remark;//备注

@property (nonatomic, retain) NSString *		member_title;
@property (nonatomic, retain) NSString *		member_id;
@property (nonatomic, retain) NSString *		member_tele;
@property (nonatomic, retain) NSString *		is_check;
@end
...
@property (nonatomic, retain) NSString *		shop_address;
@property (nonatomic, retain) NSString *		shop_caixi;
