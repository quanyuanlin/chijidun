...
- (void) creatContainerView{
    ...
    self.containerView.backgroundColor =[UIColor colorWithRed:0.96 green:1.0 blue:1.0 alpha:1.0];
...
- (void)setUpDefaultView{
    ...
    titleLabel.font=[UIFont LightFontOfSize:titleFont];
    ...
    // label获取字体
    messageLabel.font = [UIFont LightFontOfSize:messageFont];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<self.items.count; i++) {
        ...
        [closeButton.titleLabel setFont:[UIFont LightFontOfSize:buttonFont]];
