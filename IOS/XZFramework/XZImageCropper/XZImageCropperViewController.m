...
@interface XZImageCropperViewController ()
...
@implementation XZImageCropperViewController
...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = [[TConfig shared] APP_MAIN_COLOR].CGColor;
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(XZImageCropperDelegate)]) {
